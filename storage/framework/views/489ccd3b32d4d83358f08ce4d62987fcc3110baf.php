...
<link rel="stylesheet" href="<?php echo e(secure_asset('/public/css/custom_checkout.css').'?t='.time()); ?>">
...
<body onload="onload()">
   ...
   <div class="container">
      <!--Right Section-->
      <div id="primary">
      <?php echo e(Form::open(array('url' => secure_url('swapp/checkout/shipping'), 'class' =>'form kachyng_checkout', 'id' =>'payment-form', 'onsubmit' => 'tokenizeCard1(); return false;'))); ?>
      ...
      <input type="hidden"  name="order_id" id="order_id" value="<?php echo e($order_id); ?>">
      <div id="order_review">
      ...
      <span id="shipp_price"> 
      <?php echo e(round($cart_data['shipping_rates'], 2)); ?>
      ...
      <div class="panel-heading">
          <h5 class="panel-title">Contact information 
            <?php if(($user) == 'guest'): ?>
               <span class="account-login"> Already have an account? <a href="https://<?php echo e($shop); ?>/account/login">Log in</a></span>
            <?php endif; ?>
          </h5>
      </div>
      ...
      <?php echo e(Form::text('cus_add_address1', $customer_data['cus_add_address1'], array('class' => 'cus_add_address1 tile-case', 'id' => 'cus_add_address1', 'placeholder' => 'Address'))); ?>

      </p>
      <p class="group form-row form-row-wide address-field" id="billing_address_2_field" >
      <label>Apartment, suite, etc. (optional)</label>
      <?php echo e(Form::text('cus_add_address2', $customer_data['cus_add_address2'], array('class' => 'cus_add_address2 tile-case','id' => 'cus_add_address2', 'placeholder' => 'Apartment, suite, etc. (optional)'))); ?>
      ...
      <?php echo e(Form::text('customer_phone', $customer_data['cus_add_phone'], array('class' => 'customer_phone', 'id' => 'customer_phone', 'placeholder' => 'Mobile number'))); ?>
      ...
      <?php if($checkout_type == "multistep"): ?>
         <div class="row" style="width: 100%">
            ...
            <div class="col-md-6" style="padding: 0px;">
               ...
               <input name="zipcode" type="tel" class="form-control usd" id="zip_code" value="<?php echo e(@$cart_data['h_zipcode']); ?>" style="border-radius: 4px;">
            </div>
         </div>  
      <?php else: ?>
         <div class="form-row">
            ...
            <div class="form-group col-md-6" style="padding: 0px;">
               ...
               <label>ZIP code<span style="color:red;"> *</span></label>
               <input name="zipcode" type="tel" class="form-control usd" id="zip_code" value="<?php echo e(@$cart_data['h_zipcode']); ?>" disabled style="border-radius: 4px;">
               </div>
            </div>
         </div>
      <?php endif; ?> 
      ...
      <a href="https://<?php echo e($shop); ?>/cart"><i class="fa fa-chevron-left" aria-hidden="true"></i> Return to Cart</a>
      ...
      <?php echo $__env->make('pages/checkoutinfo', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php endif; ?>
<?php endif; ?>  
<?php if($checkout_type == "multistep" && $user == 'guest'): ?>
<script>
   $(document).ready(function(){
   ...
   $(document).ready(function () {
     ...
     $(window).on('load', function () {
        ...
        if (countryID) {
         $.ajax({
           type: "GET",
           url: "<?php echo e(secure_asset('swapp/checkout-states/fetch-states')); ?>?code=" + countryID,
