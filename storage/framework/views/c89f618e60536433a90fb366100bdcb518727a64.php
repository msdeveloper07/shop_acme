...
<body onload="onload()">
   <div id="content" class="checkout-page">
      <div class="container">
                           ...
                           <td class="product__image">
                              <div class="product-thumbnail">
                                 <div class="product-thumbnail__wrapper">
                                    <?php if(array_key_exists('image',$cart_data)): ?>
                                       <?php $__currentLoopData = $cart_data['image']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $c_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  											<div class="prdct-img-mobile"><div class="thubnail-img-width"><img class="product-thumbnail__image" src="<?php echo e($c_image); ?>"><span class="quantity-digits">2</span></div>
                                          <span id="pname"><?php echo e(@$cart_data['productTitle'][$key]); ?></span>
                                          <span id="pdescription"><?php echo e(@$cart_data['productDES'][$key]); ?></span>
                                        </div>

                  										 <?php if(array_key_exists('product_price',$cart_data)): ?>
                  											 <span class="product__price">
                  											 <strong><?php echo e($currency_symbol); ?> <?php echo e(@$cart_data['product_price'][$key]); ?></strong>
                  											 </span>
                  										 <?php endif; ?>
                     ...
                     <tbody>
                        ...
                        <tr class="tax_line">
                          ...
                          <strong id="show_tax_line">
                             <span class="woocommerce-Price-currencySymbol" ><?php echo e($currency_symbol); ?></span> 0.00
                          </strong>
                          </td>
                       </tr>
                       ...
                       <tr class="discount_line" style="display: none;">
                        ...
                        <tr class="shipping_method">
                          ...
                          <strong id="shipping_method_line">
                             ...
                             <?php echo e(@$cart_data['h_shipping_method']); ?>
         ...
         <!--Right Section-->
         <div id="primary">
         <?php echo e(Form::open(array('url' => secure_url('swapp/checkout/shipping'), 'class' =>'form kachyng_checkout', 'id' =>'payment-form', 'onsubmit' => 'tokenizeCard(); return false;'))); ?>

         <input type="hidden"  name="payment_method_token" id="payment_method_token" value="">
         <input type="hidden"  name="usertype" id="usertype" value="<?php echo e($user_type); ?>">
         <input type="hidden"  name="customer_ID" id="customerID" value="<?php echo e(@$customer_id); ?>">
         <div id="order_review">
         <table class="product-table">
         <tbody>
         <?php $__currentLoopData = $cart_datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    				 ...
    				 <div class="product-thumbnail">
    					 <div class="product-thumbnail__wrapper">
    						...
    						<div class="img-with-quantity" >
    						   <div class="prdct-img"><div class="thubnail-img-width"><img class="product-thumbnail__image" src="<?php echo e($c_image); ?>"><span class="quantity-digits">2</span></div>
                    <span id="pname"><?php echo e(@$cart_data['productTitle'][$key]); ?></span>
                    <span id="pdescription"><?php echo e(@$cart_data['productDES'][$key]); ?></span>
                   </div>
    						   <span class="product-thumbnail__quantity" style="display: none;"><?php echo e($cart_data['quantity']); ?></span> 
    						   <?php if(array_key_exists('product_price',$cart_data)): ?>
    								 <span class="product__price">
    									<strong><?php echo e($currency_symbol); ?> <?php echo e(@$cart_data['product_price'][$key]); ?></strong>
    								 </span>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         ...
         <tr class="cart-subtotal">
         <th><strong>Subtotal</strong></th>
         <td><strong><span class="woocommerce-Price-currencySymbol"><?php echo e($currency_symbol); ?></span> <?php echo e($total_price); ?></strong></td>
         </tr>
         <tr class="cart_item">
         ...
         <span id="showID" >
         <?php if($cart_data['shipping_rates'] != 0): ?> 
         <strong><span class="woocommerce-Price-currencySymbol"><?php echo e($currency_symbol); ?></span>
         <span id="shipp_price"> 
            <?php echo e($cart_data['shipping_rates']); ?>
         ...
         <th>Total</th>
         <td>
         <strong id="old_total_pri"><span class="woocommerce-Price-currencySymbol" ><?php echo e($currency_symbol); ?></span> <?php echo e(number_format($cart_data['shipping_rates'] + $total_price, 2)); ?></strong>
         ...
         <a class="step__footer__previous-link" href="https://<?php echo e($shop); ?>/cart">
         ...
         <a href="<?php echo e($shop); ?>" rel="home">
        ...
        <!--  <div class="login_fb loginBtn loginBtn--facebook"><a href="javascript:void(0);" onclick="fbLogin()" id="fbLink">Login with Facebook</a></div>or Checkout As Guest</span> -->
         ...
         <?php if(($user) != 'guest'): ?>
         <?php echo e(Form::email('customer_email', $customer_data['customer_email'], array('class' => 'customer_email','id' => 'customer_email', 'placeholder' => 'Email', 'required', 'readonly'))); ?>

         <?php else: ?>
         <?php echo e(Form::email('customer_email', $customer_data['customer_email'], array('class' => 'customer_email','id' => 'customer_email', 'placeholder' => 'Email', 'required'))); ?>
         ...
         <?php $__currentLoopData = $saved_cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $saved_card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="firstmn">
              <div class="input-mn">
                <input type="radio" id="saved_card" name="Saved Card" value="<?php echo e($saved_card['cardRef']); ?>" <?php if(!$index): ?> <?php echo "checked"; ?> <?php endif; ?>>
              </div> 
              <div class="acc-mn"> 
                <?php echo e($saved_card['cardDisplay']); ?> 
              </div>
            </div>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        
         <?php echo e(Form::text('cvv_saved', "", array('class' => 'form-control', 'placeholder' => 'CVV', 'id'=>'cvv_saved'))); ?>
    ...
    <div id="new_cc">
      ...
      <span class="savedcardt">Save card &nbsp; <input type="checkbox" checked="checked"></span>
         ...
         <?php echo e(Form::text('customer_first_name', $customer_data['cus_add_first_name'], array('class' => 'customer_first_name tile-case','id' => 'customer_first_name', 'placeholder' => 'First name'))); ?>

         </p>
         <p class="form-row form-row-last group" id="billing_last_name_field">
         <?php echo e(Form::text('customer_last_name', $customer_data['cus_add_last_name'], array('class' => 'customer_last_name customer_last_check tile-case', 'id' => 'customer_last_name_test', 'placeholder' => 'Last name'))); ?>

         </p>
         <p class="group form-row form-row-wide address-field validate-required" id="billing_address_1_field">
         <?php echo e(Form::text('cus_add_address1', $customer_data['cus_add_address1'], array('class' => 'cus_add_address1 tile-case', 'id' => 'cus_add_address1', 'placeholder' => 'Address line 1'))); ?>

         </p>
         <p class="group form-row form-row-wide address-field" id="billing_address_2_field" >
         <?php echo e(Form::text('cus_add_address2', $customer_data['cus_add_address2'], array('class' => 'cus_add_address2 tile-case','id' => 'cus_add_address2', 'placeholder' => 'Address line 2'))); ?>

         </p>
         <!---<p class="form-row form-row-wide address-field" id="billing_country_field">
            <select name="cus_add_country1" id="bill_country" class="country_to_state country_select cus_add_country form-control gds-cr" country-data-default-value="<?php echo e($customer_data['country_code']); ?>" placeholder="country" country-data-region-id="gds-cr-1"></select> 
            </p>
            <p class="form-row form-row-wide address-field " id="billing_state_field" >
            <select name="cus_add_province1" class="state_select cus_add_province form-control" placeholder="province" id="gds-cr-1" region-data-default-value="<?php echo e($customer_data['province']); ?>"></select>
            </p>
            
            <p class="group form-row form-row-wide  address-field" id="billing_postcode_field" >
            <?php echo e(Form::text('cus_add_zip', $customer_data['cus_add_zip'], array('class' => 'cus_add_zip','id' => 'cus_add_zip', 'placeholder' => 'Zipcode'))); ?>

            </p>
            
            --->
         <p class="form-row form-row-wide address-field" id="billing_city_field" data-priority="70">
         <?php echo e(Form::text('cus_add_city', $customer_data['cus_add_city'], array('class' => 'cus_add_city tile-case','id' => 'cus_add_city', 'placeholder' => 'City'))); ?>
         ...
         <input name="country" type="text" class="form-control usd" id="country" value="<?php echo e(@$cart_data['h_country']); ?>" disabled>
         </div>
            
         <div class="col-md-41 state-fld pr-0 ml-3">
         <div class="form-group form-group-default form-group-default-select2">
         <label class="">State</label>
         <input name="state" type="text" class="form-control usd" id="state" value="<?php echo e(@$cart_data['h_state']); ?>" disabled>
         </div>
         </div>
         ...
         <input name="zipcode" type="tel" class="form-control usd" id="zip_code" value="<?php echo e(@$cart_data['h_zipcode']); ?>" disabled>
         </div>
         </div>
         </div>         
         ...
         <p class="group form-row form-row-wide address-field validate-required" id="billing_address_1_field">
         <?php echo e(Form::text('green_add_address1', '', array('class' => 'green_add_address1', 'id' => 'green_add_address1', 'placeholder' => 'Address Line 1'))); ?>

         </p>
         <p class="group form-row form-row-wide address-field" id="green_billing_address_2_field" >
         <?php echo e(Form::text('green_add_address2', '', array('class' => 'green_add_address2','id' => 'green_add_address2', 'placeholder' => 'Address Line 2'))); ?>
         ...
         <label class="">State</label>
         <p class="group form-row form-row-wide" >
         <input name="green_add_province" type="text" class="green_state_select cus_add_province form-control"  value="<?php echo e(@$cart_data['h_state']); ?>" region-data-default-value="<?php echo e(@$cart_data['h_state']); ?>" id="gds-cr-3" disabled>
         </p>
        </div>
        </div>
        ...
        <div class="col-md-41 zip-fld pr-0">
         ...
         <label>ZIP code</label>
         <p class="group form-row form-row-wide  address-field" id="billing_postcode_field">
         <input name="green_add_zip" type="tel" class="green_add_zip" id="green_add_zip" value="<?php echo e(@$cart_data['h_zipcode']); ?>" disabled>
         ...
         <?php echo e(Form::tel('green_phone', '', array('class' => 'green_phone', 'id' => 'green_phone', 'placeholder' => 'Mobile number'))); ?>
        ...
        <div class="shipping-address shipping-address-mob">
         ...
         <p class="group form-row form-row-wide address-field validate-required" id="billing_address_1_field">
         <?php echo e(Form::text('red_add_address1', '', array('class' => 'red_add_address1', 'id' => 'red_add_address1', 'placeholder' => 'Address Line 1'))); ?>

         </p>
         <p class="group form-row form-row-wide address-field" id="red_billing_address_2_field" >
         <?php echo e(Form::text('red_add_address2', '', array('class' => 'red_add_address2','id' => 'red_add_address2', 'placeholder' => 'Address Line 2'))); ?>
         ...
         <label class="">State</label>
         <p class="group form-row form-row-wide" >
         <input name="red_add_province" type="text" class="red_state_select cus_add_province form-control"  value="<?php echo e(@$cart_data['h_state']); ?>" region-data-default-value="<?php echo e(@$cart_data['h_state']); ?>" disabled>
         </p> 
         </div>
         </div>
         ...
         <label>ZIP code</label>
         <p class="group form-row form-row-wide  address-field" id="billing_postcode_field">
         <input name="red_add_zip" type="tel" class="red_add_zip" id="red_add_zip" value="<?php echo e(@$cart_data['h_zipcode']); ?>" disabled>
         </p>
         </div>
         </div>
         </div>
         ...
         <?php echo e(Form::tel('red_phone', '', array('class' => 'red_phone', 'id' => 'red_phone', 'placeholder' => 'Mobile number'))); ?>
         ...
         <?php echo e(Form::tel('customer_phone', $customer_data['cus_add_phone'], array('class' => 'customer_phone', 'id' => 'customer_phone', 'placeholder' => 'Mobile number'))); ?>
         ...
         <a id="one_step_back" class="step__footer__previous-link" href="https://<?php echo e($shop); ?>/cart">
         <svg focusable="false" aria-hidden="true" class="icon-svg icon-svg--color-accent icon-svg--size-10 previous-link__icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10">
         <path d="M8 1L7 0 3 4 2 5l1 1 4 4 1-1-4-4"></path>
         </svg>
         <span class="step__footer__previous-link-content">Return to cart</span>
         ...
         <?php echo e(Form::hidden('raw_data', $raw, array('id' => 'raw_data'))); ?>

         <?php echo e(Form::hidden('user', $user, array('id' => 'user'))); ?>
    ...
    $(document).ready(function () {
      ...
      $('#discount_form').submit(function () {
        ...
        $.ajax({
            type: 'POST',
            dataType: "json",
            url: "<?php echo e(secure_asset('swapp/checkout/apply-code')); ?>",
      ...
      $.ajax({
        type: "GET",
        url: "<?php echo e(secure_asset('swapp/checkout/fetch-afstates')); ?>?code=" + 'AF',
      ...
      $('#country').change(function () {
        ...
        if (countryID) {
          $.ajax({
            type: "GET",
            url: "<?php echo e(secure_asset('swapp/checkout/fetch-states')); ?>?code=" + countryID,
  ...
  <script>
    ...
    var AjaxValidate = {
      call: function (email, fname, lname, zip_code, address, city, country, state) {
        ...
        this.xhr = $.ajax({
          url: "<?php echo e(secure_asset('swapp/checkout/activecarriers')); ?>",
          dataType: "json",
          cache: false,
          type: 'POST',
          data: {
            ...
            if (order_check) {
              ...
              if (res.success === 'true') {
                ...
                setInterval(function () {
                  this.xhr = $.ajax({
                    url: "<?php echo e(secure_asset('swapp/checkout/withoutShipping')); ?>",
                    dataType: "json",
                    cache: false,
                    type: 'POST',
                    data: {
    ...
    $(document).on("click", ".radio,.radio-success", function () {
      ...
      $.ajax({
        url: "<?php echo e(secure_asset('swapp/checkout/total-price')); ?>/" + combine,
        type: "GET",
        dataType: "json",
        cache: false,
  ...
  <script> 
   ...
   $('#remove-class').on('click', function () {
    ...
    $('#calculate_shipping').on('click', function () {
      $.ajax({
        type: 'GET',
        url: '<?php echo e($shop); ?>/cart/shipping_rates.json',
