...
.dropp-body label:last-child {border-bottom: 0px solid #ccc;}
   ...
   <div id="content" class="checkout-page">
      <div class="container">
                           ...
                           <td class="product__image">
                              <div class="product-thumbnail">
                                 <div class="product-thumbnail__wrapper">
                                        ...
                                        <div class="prdct-img-mobile"><div class="thubnail-img-width"><img class="product-thumbnail__image" src="<?php echo e($cart_data['image']); ?>"><span class="quantity-digits"><?php echo e(@$cart_data['quantity']); ?></span></div>
                                          <span id="pname"><?php echo e(@$cart_data['productTitle']); ?></span>
    			 ...
    			 <td class="product__image">
    				 <div class="product-thumbnail">
    					 <div class="product-thumbnail__wrapper">
    						...
    						<div class="prdct-img"><div class="thubnail-img-width"><img class="product-thumbnail__image" src="<?php echo e($cart_data['image']); ?>">

                    <span class="quantity-digits"><?php echo e($cart_data['quantity']); ?></span></div>
                    <span id="pname"><?php echo e(@$cart_data['productTitle']); ?></span>
                    <span id="pdescription"><?php echo e(@$cart_data['productDES']); ?></span>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         ...
         <a href="https://<?php echo e($shop); ?>" rel="home">
        ...
        <div class="saved-credit-c"> 
          ...
          <div class="dropp">
            <div class="dropp-header">
              <span class="dropp-header__title js-value">Select Saved card</span> 
    ...
    <div id="new_cc">
      ...
      <span class="savedcardt">Save card &nbsp; <input type="checkbox" checked="checked"></span>
         ...
         <?php echo e(Form::text('cus_add_address1', $customer_data['cus_add_address1'], array('class' => 'cus_add_address1 tile-case', 'id' => 'cus_add_address1', 'placeholder' => 'Address Line1'))); ?>

         </p>
         <p class="group form-row form-row-wide address-field" id="billing_address_2_field" >
          <label>Address Line2</label>
         <?php echo e(Form::text('cus_add_address2', $customer_data['cus_add_address2'], array('class' => 'cus_add_address2 tile-case','id' => 'cus_add_address2', 'placeholder' => 'Address Line2'))); ?>
        ...
        <div class="shipping-address shipping-address-mob">
         ...
         <p class="group form-row form-row-wide 2" id="billing_phone_field" style="display: none;">
          <label>Mobile number</label>
         <?php echo e(Form::number('customer_phone', $customer_data['cus_add_phone'], array('class' => 'customer_phone', 'id' => 'customer_phone', 'placeholder' => 'Mobile number'))); ?>
