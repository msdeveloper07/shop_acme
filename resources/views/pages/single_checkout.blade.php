   ...
   <div id="content" class="checkout-page">
                           ...
                           <td class="product__image">
                              <div class="product-thumbnail">
                                 <div class="product-thumbnail__wrapper">
                                        ...
                                        <div class="prdct-img-mobile"><div class="thubnail-img-width"><img class="product-thumbnail__image" src="{{$cart_data['image']}}"><span class="quantity-digits">{{@$cart_data['quantity'] }}</span></div>
    ...
    <div id="new_cc">
      ...
      <span class="savedcardt">Save card &nbsp; <input type="checkbox" checked="checked"></span>
         ...
         {{Form::text('cus_add_address1', $customer_data['cus_add_address1'], array('class' => 'cus_add_address1 tile-case', 'id' => 'cus_add_address1', 'placeholder' => 'Address Line1'))}}
         </p>
         <p class="group form-row form-row-wide address-field" id="billing_address_2_field" >
          <label>Address Line2</label>
         {{Form::text('cus_add_address2', $customer_data['cus_add_address2'], array('class' => 'cus_add_address2 tile-case','id' => 'cus_add_address2', 'placeholder' => 'Address Line2'))}}
         </p>
        ...
        <div class="shipping-address shipping-address-mob">
         ...
         <p class="group form-row form-row-wide 2" id="billing_phone_field" style="display: none;">
          <label>Mobile number</label>
         {{Form::number('customer_phone', $customer_data['cus_add_phone'], array('class' => 'customer_phone', 'id' => 'customer_phone', 'placeholder' => 'Mobile number'))}}
         </p>
