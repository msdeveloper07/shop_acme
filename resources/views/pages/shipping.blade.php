...
<div class="container">
	...
	<ul id="carriers_list">
		@foreach($carriers['data']['carriers'] as $index => $carrier)
		  <li>
		    <input type="radio" id="t-option" name="carrier" value="{{$carrier['carrier_id']}}" @if (!$index) {!! "checked" !!} @endif>
		    <label for="t-option">{{$carrier['carrier_code']}}</label>
