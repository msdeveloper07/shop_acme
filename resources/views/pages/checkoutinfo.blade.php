            ...
            <tbody>
               ...
               <tr class="shipping_method">
                  ...
                  <td>
                     ...
                     {{round(@$cart_data['h_shipping_method'], 2)}}
                     </strong>
                  </td>
               </tr>
            </tbody>
            <tfoot>
               <tr class="order-total">
                  ...
                  <td><strong id="total_mob">
                     <span class="woocommerce-Price-currencySymbol">{{@$currency_symbol}}</span> 
                     {{ number_format(@$cart_data['shipping_rates'] + @$total_price, 2) }}
                     </strong> 
                  </td>
               </tr>
            </tfoot>
               ...
               <div role="row" class="review-block">
                  <div class="review-block__inner">
                     ...
                     <div role="cell" class="review-block__content">
                        <bdo dir="ltr">{{@$customer_data['customer_email']}}</bdo>
                     </div>
         ...
         <div class="section__content">
            <fieldset class="content-box">
               <div class="content-box__row">
                  @foreach ($kachyng_shippping as $index => $shiprate)
                  <div class="radio-wrapper" data-shipping-package="usps-FirstPackage-3.25">
                     <div class="radio__input">
                     <input type="radio" id="shipping_package" name="shipping_package" value="" shipping_package="{{$shiprate->package_name}}" carrier_id="{{$shiprate->carrier_id}}" @if (!$index) {!!"checked" !!} @endif>
                     </div>
                     <label class="radio__label" aria-hidden="true">
                        <span class="radio__label__primary" data-shipping-package-label-title="{{$shiprate->package_name}}">
                        {{$shiprate->package_name}}
...
<div class="section-payment-info" style="display: none;">
   ...
   <div class="content-box">
      ...
      <div class="saved-credit-c">
         ...
         <div class="dropp">
            <div class="dropp-header">
               <span class="dropp-header__title js-value">{{$saved_cards[0]['cardType']}} {{$saved_cards[0]['cardDisplay']}} {{$saved_cards[0]['expiry']}}</span> 
                
            </div>
            <div class="dropp-body">
               <label class="" for="saved_cards">
                  <span id="sc">
                  {{$saved_cards[0]['cardType']}} {{$saved_cards[0]['cardDisplay']}} {{$saved_cards[0]['expiry']}}
                  </span>
                  <input type="radio" id="saved_card" name="Saved Card" value="{{$saved_cards[0]['cardRef']}}">
                  <div class="check-my-btn" value="{{$saved_cards[0]['cardType']}} {{$saved_cards[0]['cardDisplay']}}  {{$saved_cards[0]['expiry'] }}">
         ...
         <div class="dropp">
            ...
            <div class="dropp-body">
               ...
               <label class="" for="saved_cards">
                  <span id="sc">
                  {{$saved_card['cardType']}} {{$saved_card['cardDisplay']}} {{$saved_card['expiry']}}
                  </span>
                  <input type="radio" id="saved_card" name="Saved Card" value="{{$saved_card['cardRef']}}">
                  <div class="check-my-btn" value="{{$saved_card['cardType']}} {{$saved_card['cardDisplay']}}  {{$saved_card['expiry'] }}">
                     <div class="inside"></div>
                  </div>
               </label>
               @endforeach
      ...
      {{Form::text('cvv_saved', "", array('class' => 'form-control', 'placeholder' => 'CVV', 'id'=>'cvv_saved', 'style'=>'display:none' ))}}
      @endif
      @endif
      <div id="new_cc">
         @if ($saved_cards) 
         ...
         <div class="green box shipping_address gnmain" style="">
            <div class="woocommerce-shipping-fields__field-wrapper">
               ...
               <p class="group form-row form-row-wide address-field validate-required" id="billing_address_1_field">
                  ...
                  {{Form::text('green_add_address1', '', array('class' => 'green_add_address1', 'id' => 'green_add_address1', 'placeholder' => 'Address Line1'))}}
               </p>
               <p class="group form-row form-row-wide address-field" id="green_billing_address_2_field" >
                  <label class="">Address Line2</label>
                  {{Form::text('green_add_address2', '', array('class' => 'green_add_address2','id' => 'green_add_address2', 'placeholder' => 'Address Line2'))}}
               </p>
                  ...
                  <div class="col-md-4 state-fld pr-0 ml-3">
                     <div class="form-group form-group-default form-group-default-select2">
                        ...
                        <p class="group form-row form-row-wide" >
                           <input name="green_add_province" type="text" class="green_state_select cus_add_province form-control"  value="{{@$cart_data['h_state']}}" region-data-default-value="{{@$cart_data['h_state']}}" id="gds-cr-3">
                        </p>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="form-group form-group-default input-group fw-100">
                        <div class="form-input-group">
                           ...
                           <p class="group form-row form-row-wide  address-field" id="billing_postcode_field">
                              <input name="green_add_zip" type="tel" class="green_add_zip" id="green_add_zip" value="{{@$cart_data['h_zipcode']}}">
                           </p>
                        </div>
                     </div>
                  </div>
               ...
               <p class="group form-row form-row-wide 1" id="billing_phone_field" style="display: none;">
                  ...
                  {{Form::number('green_phone', '', array('class' => 'green_phone', 'id' => 'green_phone', 'placeholder' => 'Mobile number'))}}
               </p>
            </div>
         </div>
      </div>
         ...
         <div class="red box shipping_address" style="">
            <div class="woocommerce-shipping-fields__field-wrapper">
               ...
               <p class="group form-row form-row-wide address-field validate-required" id="billing_address_1_field">
                  ...
                  {{Form::text('red_add_address1', '', array('class' => 'red_add_address1', 'id' => 'red_add_address1', 'placeholder' => 'Address Line1'))}}
               </p>
               <p class="group form-row form-row-wide address-field" id="red_billing_address_2_field" >
                  <label>Address Line2</label>
                  {{Form::text('red_add_address2', '', array('class' => 'red_add_address2','id' => 'red_add_address2', 'placeholder' => 'Address Line2'))}}
               </p>
               <p class="group form-row form-row-wide address-field" id="billing_city_field" data-priority="70">
                  <label>City</label>
               ...
               <div class="row pt-0">
                  ...
                  <div class="col-md-4 state-fld pr-0 ml-3">
                     <div class="form-group form-group-default form-group-default-select2">
                        <label class="">State</label>
                        <p class="group form-row form-row-wide" >
                           <input name="red_add_province" type="text" class="red_state_select cus_add_province form-control"  value="{{@$cart_data['h_state']}}" region-data-default-value="{{@$cart_data['h_state']}}">
                        </p>
                     </div>
                  </div>
                  ...
                  <div class="col-md-4 zip-fld pr-0">
                     <div class="form-group form-group-default input-group fw-100">
                        <div class="form-input-group">
                           <label>ZIP code</label>
                           <p class="group form-row form-row-wide  address-field" id="billing_postcode_field">
                              <input name="red_add_zip" type="tel" class="red_add_zip" id="red_add_zip" value="{{@$cart_data['h_zipcode']}}">
                           </p>
                        </div>
                     </div>
                  </div>
               ...
               <p class="group form-row form-row-wide 3" id="billing_phone_field" style="display: none;">
                  <label>Mobile number</label>
                  {{Form::number('red_phone', '', array('class' => 'red_phone', 'id' => 'red_phone', 'placeholder' => 'Mobile number'))}}
               </p>
            </div>
         </div>
      </div>
