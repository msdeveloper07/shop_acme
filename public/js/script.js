   $(document).ready(function() {
       ...
       $.ajax({
           type: "GET",
           url: baseUrl + '/swapp/main/get_all_data',
           beforeSend: function() {
               $('#loading-image').show();
           },
           complete: function() {
       ...
       $('.form_login').on('submit', function(event) {
           ...
           var formData = {
               ...
               checkout_type: $('#checkout').find(":selected").text()
           }
           $.ajax({
               type: "POST",
               url: $(this).attr('action'),
               ...
               success: function(data) {
                  console.log(data);
                  localStorage.setItem("checkouttype", $('#checkout').find(":selected").text());
                  console.log(localStorage.getItem('checkouttype'));
               }
           })
       });
   });
